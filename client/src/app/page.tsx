...
export default function Home() {
  return (
    <main>
      <div className="flex flex-col min-h-screen min-w-fit items-center justify-between py-96 text-yellow bg-cafeHomepage bg-cover">
      ...
      <div id="about" className="flex flex-col items-center">
        ...
        <div className="flex flex-row min-w-full min-h-[600px]">
          ...
          <div className="flex flex-col relative h-[600px] w-[1315px] text-center bg-beigePrimary">
            <h1 className="text-4xl my-24 text-gray">Drinks</h1>
            <p className="text-2xl text-gold">Refreshing drinks after a long day.</p>
          </div>
        </div>
        {/* Second */}
        <div className="flex flex-row min-w-full min-h-[600px] bg-beigePrimary">
          <div className="relative h-[600px] w-[1315px] text-center">
            ...
            <p className="text-2xl text-gold">Tasty desserts such as cakes, croffles, and macarons.</p>
          </div>
          <div className="relative h-[600px] w-[800px]">
            <Image
        ...
        <div className="flex flex-row min-w-full min-h-[600px] bg-beigePrimary">
          ...
          <div className="relative h-[600px] w-[1315px] text-center">
            ...
            <p className="text-2xl text-gold">Carefully arranged flowers for any special occassion.</p>
          </div>
        </div>
        {/* Fourth */}
        <div className="flex flex-row min-w-full min-h-[600px] bg-beigePrimary">
          ...
          <h1 className="text-4xl my-24 text-gray">Table Reservations</h1>
            <p className="text-2xl text-gold">A perfect space for many activities, whether it be quiet studying or to catch up with friends.</p>
          </div>
          <div className="relative h-[600px] w-[800px]">
            <Image
        ...
        <div className="flex flex-row min-w-full min-h-[600px] bg-beigePrimary">
          ...
          <div className="relative h-[600px] w-[1315px] text-center">
            ...
            <p className="text-2xl text-gold">Conveniently order your desserts, drinks, and flowers on the go. We will make sure that they are ready for pickup when you arrive.</p>
          </div>
        </div>
      </div>
    </main>
